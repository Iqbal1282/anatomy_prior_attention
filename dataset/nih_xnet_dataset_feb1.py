...
MASK_DIR = '/home/mhealthclust1/Desktop/codebase_rafi/anatomy_xnet_nih/nih_anatomy_masks_v2/'
...
def get_train_transforms():      
    return A.Compose([
        ...
        'mask8' : 'mask', 'mask9' : 'mask', 'mask10' : 'mask', 'mask11' : 'mask', 'mask12' : 'mask', 'mask13' : 'mask', 'mask14' : 'mask'
    })
...
class ChestXrayDataSet_maskfused(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return transformed_image, transformed_masks, torch.FloatTensor(label)
